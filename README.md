...
![alt text]({F1852775-CCFB-4429-A523-3584C7EE3B88}.png)

The simulation results revealed significant spatial and temporal variability in flood response throughout the Anambra River Basin. Critical flow locations included the basin outlet, identified as Sink-1, which recorded the highest peak discharge of **24,145.0 m³/s** at **11:42 AM** on **June 14, 2025**. Reach-6 followed closely with a peak of **21,070.7 m³/s** at **11:56 AM**, while Reach-1 and Reach-4 experienced peak flows of **15,207.5 m³/s** and **11,306.9 m³/s** at **11:50 AM** and **11:44 AM**, respectively.
