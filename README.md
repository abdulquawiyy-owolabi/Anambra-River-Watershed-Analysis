...
The simulation results revealed significant spatial and temporal variability in flood response throughout the Anambra River Basin. Critical flow locations included the basin outlet located near Otuocha community, which recorded the highest peak discharge of **24,145.0 m³/s** at **11:42 AM** on **June 14, 2025** as shown in Figure 1 below. Reach-6 followed closely with a peak of **21,070.7 m³/s** at **11:56 AM**, while Reach-1 and Reach-4 experienced peak flows of **15,207.5 m³/s** and **11,306.9 m³/s** at **11:50 AM** and **11:44 AM**, respectively.
![alt text]({F1852775-CCFB-4429-A523-3584C7EE3B88}-1.png)
Figure 1: Outflow of the Basin Outlet in Otuocha.
![alt text]({F2E6E97A-D586-46E1-87BD-5C0516F3882A}.png)
